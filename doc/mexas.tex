...
Figure~\mexref{STACK-AND-FLOW-CONTROL-INSTRUCTIONS}.
...
Figure~\mexref{STACK-AND-FLOW-CONTROL-INSTRUCTIONS}.  At assembly-time,
this instruction 
...
Figure~\mexref{STACK-AND-FLOW-CONTROL-INSTRUCTIONS}, where the \TT{*}
...
\begin{indpar}
At run-time this instruction's actions are as described in
Figure~\mexref{STACK-AND-FLOW-CONTROL-INSTRUCTIONS}, where {\em variable-name}
...
\begin{indpar}
At run-time this instruction's actions are as described in
Figure~\mexref{STACK-AND-HOUSEKEEPING-INSTRUCTIONS} with \TT{immedB} set
...
(see Figure~\mexref{STACK-AND-HOUSEKEEPING-INSTRUCTIONS}).  At assembly-time,
