...
% Date:		Sat Jan 11 03:53:03 AM EST 2025
...
\newcommand{\mexref}[1]{\ref{#1}$\,^{mex\pageref{#1}}$}
\newcommand{\mexasref}[1]{\ref{#1}$\,^{mexas\pageref{#1}}$}
\newcommand{\pagref}[1]{p\pageref{#1}}
\newcommand{\pagnote}[1]{$\,^{p\pageref{#1}}$}
\newcommand{\mexnote}[1]{$\,^{mex\pageref{#1}}$}
\newcommand{\mexasnote}[1]{$\,^{mexas\pageref{#1}}$}
