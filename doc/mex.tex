...
\verb|enum mexcome::| \MEXCOMKEY{print} \\
\verb|{| \\
\verb|    mexcom::| \MEXCOMKEY{NO\_PRINT}, \\
\verb|    mexcom::| \MEXCOMKEY{PRINT}, \\
\verb|    mexcom::| \MEXCOMKEY{PRINT\_WITH\_SOURCE} \\
\verb|}| \\
\verb|mexcom::print mexcom::| \MEXCOMKEY{print\_switch}
    \verb|= mexcom::NO_PRINT| \\
\verb|void mexcom::| \MEXCOMKEY{trace\_instr} \\
\verb|        ( min::uns32 location,| \\
\verb|          min::uns32 stack_length,| \\
\verb|          bool no_source = false )|
\begin{indpar}
Print trace of instruction at {\tt mexcom::output\_module[location]},
as per {\tt mexcom::\EOL print\_switch}, except do not print source lines if
{\tt no\_source} is {\tt true}.
Printing is done using {\tt mexcom::\EOL input\_\EOL file} and
{\tt mexcom::\EOL input\_\EOL file->\EOL printer}.
The format is as in Section~\ref{TRACE-MESSAGES}.
{\tt Stack\_\EOL length} is used in the {\em trace-header} and
is usually set to {\tt mexstack::var\_stack\_length}.
\end{indpar}
