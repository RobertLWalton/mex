...
\verb|mex:|\TTMKEY{TRACE\_NOJMP}{in {\tt mex::trace\_flag}} & \tt = 1 <{}< 2 \\
\verb|}                   | \\
\end{tabular}
...
When an arithmetic instruction is traced and it's \TT{TRACE\_PHRASE} flag is on,
...
{\tt mex::module\_insptr mex::}\TTKEY{create\_module}

{\tt mex::process\_insptr mex::}\TTKEY{create\_process}
