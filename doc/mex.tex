...
TBD\\
This does not apply when a copy of a variable is pushed to the stack
while giving the copy the same name as the variable.
...
with the given {\em new-variable-name}, if provided.
\end{indpar}
