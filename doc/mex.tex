...
{\em Var-stack-length} equals {\tt run\_stack\_length}\pagnote{RUN-STACK-LENGTH}
...
{\tt mexstack::run\_stack\_length}\pagnote{RUN-STACK-LENGTH}
...
or the same name as a \TT{next-} variable of a loop\pagnote{NEXT-VARIABLE}
