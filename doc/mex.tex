...
\emkey{mexas-operation} ::=
    \begin{tabular}[t]{l@{~~~~~}l}
    {\em mex-file}			& [assemble the file] \\
    \ttkey{-ta} 			& [trace assembled instructions] \\
    \ttkey{-talines}			& [ditto and include source lines] \\
    \ttkey{-taoff}			& [do not trace
                                           assembled instructions] \\
    \ttkey{-tanever}			& [assemble with \TT{T\_NEVER}
                                           trace class] \\
    \ttkey{-tanormal}			& [assemble with normal trace class] \\
...
\emkey{trace-group} :::= trace group
    listed in Figure~\itemref{TRACE-CLASSES-AND-GROUPS} \\
\\[0.5ex]
\emkey{ex-list} :::= $|$ {\em except} \{ \TT{,} {\em except} \}\STAR{} \\
\emkey{except} :::= except listed on TBD
