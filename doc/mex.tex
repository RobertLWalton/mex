...
and if $E$ is an execution of $F$, then there is an execution $E'$ of some
function $F'$ of level $L'$ such that $E\subset E'$, and the smallest
such execution $E'$ is the execution of the unique function of
...
scope to be lexically within the definition of the function lexically
