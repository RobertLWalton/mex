...
\ttkey{PUSHI} {\em number} {\em variable-name}\QMARK{}
\begin{indpar}
...
\ttkey{PROCESS\_TRACE} {\em trace-option}\STAR{}
\begin{indpar}
At run-time set the process \TT{trace\_flags} parameter to the
flags given by the options (i.e., \TT{TRACE},
\ttkey{TRACE\_PHRASE}, \TT{TRACE\_NOJMP}).  This is implemented
by the run-time instruction \TT{SET\_TRACE}. At assembly-time,
this instruction does nothing.
\end{indpar}

\ttkey{ERROR} {\em error-code} {\em nargs}\QMARK{}
\begin{indpar}
...
\ttkey{PUSHNARGS} {\em variable-name}
\begin{indpar}
At run-time this instruction's actions are as described in
Figure~\itemref{FUNCTION-INSTRUCTIONS}.  At assembly-time,
...
\ttkey{PUSHV} {\em level}\QMARK{} {\em variable-name}\QMARK{}
\begin{indpar}
...
\TT{TRACE\_PHRASE}, \TT{TRACE\_NOJMP}).
\end{indpar}
