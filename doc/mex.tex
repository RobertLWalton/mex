...
variable.  At assembly time, pushes into the variable stack an
element whose name is the {\em new-variable-name} if that is
given, or {\em variable-name} otherwise.

The named variable stack element must have the same lexical
level as the \TT{PUSH} instruction.
\end{indpar}
...
The search for an element with the given {\em variable-name}
is restricted to variable stack elements with lexical level 0.
\end{indpar}
...
of the {\em variable-names} into the variable stack (there
