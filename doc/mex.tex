...
\verb|void mexstack::| \MEXCOMKEY{print\_instr} \\
...
the number of {\em trace-packet-variables} pushed so far, as
...
modified previously assembled instruction is printed (without its source)
just after it has
been modified, and before any instruction currently being output.
\end{indpar}
...
The block description is also used
by the {\em cont} function to fill in parts of the {\tt CONT} instruction.
