...
\ttkey{GET}
    ...
    & push \TT{mex::NONE} into the stack instead.  If \TT{immedB} is non-zero,
                                                                     \\
...
\ttkey{GETI}
    ...
    & not exist, push \TT{mex::NONE} into the stack instead.
\\\hline
\ttkey{SET}
    ...
    & require \TT{immedC} to be zero, and pop a second value (X) from the \\
    & stack.
\\\hline
\ttkey{SETI}
