...
If \TT{mexstack::lexical\_level} = $L$ when an instruction is assembled,
...
If \TT{mexstack::depth[$L$]} = $D$ when an instruction is assembled,
...
\TT{mexstack::run\_stack\_length} = $S$ when an instruction is assembled,
