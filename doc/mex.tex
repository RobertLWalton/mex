...
\begin{indpar}
{\bf Theorem}~~~If the last incomplete function execution of $E$
is an execution of function $F$ of level $L$, and if $F'$ is a function
of level $L'$ lexically containing $F$, then there is a smallest
incomplete function execution of $F'$ in $E$ which is also the
smallest incomplete function of level $L'$ in $E$.
\end{indpar}

\begin{indpar}
{\bf Proof of Theorem}: The largest incomplete function execution of $E$
must have level $1$ and the last incomplete function execution has level
$L$, and by hypothesis $1\leq L'\leq L$,
...
By applying Corollary 2 recursively to successive incomplete function
