...
traced.  These include the \TT{TRACE}, \TT{SET\_\EOL TRACE},
...
In normal mode, an error message is also produced if for exceptions
that are enabled.  In both
normal and optimized modes, an error message is produced
when the process terminates if any enabled exception flags have been raised.
See Arithmetic Exceptions, \itemref{ARITHMETIC-EXCEPTIONS}.
