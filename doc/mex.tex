...
The \TT{max\_length} of the three empty vectors is set to:
\begin{indpar}
\verb|min::uns32 mex::|\MEXKEY{module\_length}\verb|    // Default == 1 << 16.|
\end{indpar}
...
a line.  A line ending with the `\ttkey{\textbackslash}' lexeme
